...
import { BG_TOKEN_MAP, TEXT_TOKEN_MAP, BRAND_COLOR, PRIMARY_BG_COLOR, TEXT_SECONDARY_COLOR } from '@/constants/colors';
    ...
    >
      <View
        style={{
          ...
          alignItems: 'center',
          ...(isSelected && { borderWidth: 2, borderColor: BRAND_COLOR }),
        }}
      >
      ...
      >
        <View className="flex-1 justify-end" pointerEvents="box-none">
          <View
            ...
            style={{ borderTopLeftRadius: 20, borderTopRightRadius: 20, height: '80%' }}
          >
              {/* ── 标题栏 ── */}
              <View className="flex-row items-center justify-between border-b border-zinc-200 px-4" style={{ height: 56 }}>
              ...
              <View className="flex-row items-center gap-2 px-4 pt-3">
                <View className="flex-1 flex-row items-center gap-2 rounded-[10px] bg-gray-100 px-3" style={{ height: 36 }}>
